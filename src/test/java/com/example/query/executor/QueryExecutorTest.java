...
class QueryExecutorTest {
    ...
    void testTemporalJoinBefore() throws QueryExecutionException {
        ...
        MatchDetail q1_d1 = createTemporalMatchDetail(1, -1, LocalDate.of(2023, 1, 10), "q1.date");
        MatchDetail q1_d2 = createTemporalMatchDetail(2, -1, LocalDate.of(2023, 1, 15), "q1.date");
        QueryResult q1Result = createMockQueryResult(Query.Granularity.DOCUMENT, 0, List.of(q1_d1, q1_d2));

        MatchDetail q2_d3 = createTemporalMatchDetail(3, -1, LocalDate.of(2023, 1, 12), "q2.date");
    ...
    void testTemporalJoinAfter() throws QueryExecutionException {
        ...
        MatchDetail q1_d1 = createTemporalMatchDetail(1, -1, LocalDate.of(2023, 1, 15), "q1.date");
        MatchDetail q1_d2 = createTemporalMatchDetail(2, -1, LocalDate.of(2023, 1, 25), "q1.date");
        QueryResult q1Result = createMockQueryResult(Query.Granularity.DOCUMENT, 0, List.of(q1_d1, q1_d2));

        MatchDetail q2_d3 = createTemporalMatchDetail(3, -1, LocalDate.of(2023, 1, 10), "q2.date");
        MatchDetail q2_d4 = createTemporalMatchDetail(4, -1, LocalDate.of(2023, 1, 20), "q2.date");
        QueryResult q2Result = createMockQueryResult(Query.Granularity.DOCUMENT, 0, List.of(q2_d3, q2_d4));
